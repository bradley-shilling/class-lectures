...
SELECT * FROM country WHERE name > 'Q';

-- SELECT ... FROM ... WHERE ... AND/OR
-- Selecting cities in Ohio and Population greater than 400,000
SELECT * FROM city WHERE population > 400000 AND district = 'Ohio';

SELECT * FROM city WHERE population BETWEEN 400000 AND 500000 AND district = 'Ohio';
...
SELECT ABS(lifeexpectancy - 80) AS life_difference FROM country;
